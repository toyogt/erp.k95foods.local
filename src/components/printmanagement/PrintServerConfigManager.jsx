...
export default function PrintServerConfigManager() {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-4">
      <h3 className="text-sm font-semibold text-slate-900">Print Server Configurations</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
        <div><Label className="text-xs font-medium text-slate-700">Config ID</Label><Input className="h-9 text-sm" value={draft.print_server_config_id} onChange={e => setDraft({ ...draft, print_server_config_id: e.target.value })} /></div>
