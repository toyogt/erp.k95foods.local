...
import { Loader2, Inbox, Pencil, Phone, ArrowRightCircle, UserPlus } from 'lucide-react';
...
export default function CandidateLeadTable({ candidates, isLoading, onEdit, onChangeStatus, onCreateEmployee }) {
  if (isLoading) {
    return (
