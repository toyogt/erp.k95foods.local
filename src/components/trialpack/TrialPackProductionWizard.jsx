          ...
          {boxLabels.length > 0 && (
            <Card className="p-4">
              ...
              <p className="text-xs text-slate-600 mb-3">
                {boxLabels.length} box label(s) generated. Print them now.
              </p>
              ...
              <Link to={createPageUrl('BoxLabelPrint')}>
                <Button className="w-full h-14 text-base min-h-[56px]" variant="outline">
                  <Printer className="w-5 h-5 mr-2" />
                  Go to Box Label Print
                </Button>
              </Link>
            </Card>
          )}
