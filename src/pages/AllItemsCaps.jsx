...
export default function AllItemsCaps() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Caps</h1>
        <p className="text-sm text-slate-500">Manage cap types and cap specifications</p>
      </div>
