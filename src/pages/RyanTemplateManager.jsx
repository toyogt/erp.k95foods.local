...
export default function RyanTemplateManagerPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Ryan Templates</h1>
        <p className="text-sm text-slate-500">Manage printer template definitions</p>
      </div>
      <RyanTemplateManager user={user} />
    </div>
  );
}