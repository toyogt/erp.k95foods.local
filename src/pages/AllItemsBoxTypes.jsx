...
export default function AllItemsBoxTypes() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Box Types</h1>
        <p className="text-sm text-slate-500">Manage box types and packaging configurations</p>
      </div>
