...
const FLOW_STEPS = [
  ...
  { key: 'stock_validated', label: 'Stock Check',      icon: Package },
...
const STATUS_ORDER = ['draft', 'confirmed', 'stock_validated', 'picking', 'packing', 'dispatched', 'delivered', 'invoiced', 'paid', 'closed'];
